                                      ...
                                      <tr key={index}>
                                          {
                                              objKeys.map((value,indexvalue)=>{
                                                  return(
                                                      <td key={indexvalue}>
                                                          { element[value] && typeof element[value] === 'object' && this.renderChildTable(element[value],elementpath+ (!Array.isArray(element[value]) ? `-${index}-${value}` : `-${value}`  )  ) }
                                      ...
                                      <tr key={index}>
                                          {
                                              this.props.keys.map((value,indexvalue)=>{
                                                  return(
                                                      <td key={indexvalue}>
                                                          { element[value] && typeof element[value] !== 'object' && <input value={element[value]} onChange={(indexvalue)=>this.props.inputChanged(index,indexvalue,value)} className="table-input form-control"></input>}
